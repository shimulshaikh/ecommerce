 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form name="categoryForm" id="categoryForm" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="product_code" class="form-control" id="product_code" placeholder="Enter Product Code" value="{{old('product_code')}}">
                </div>
                <div class="form-group">
                    <label for="product_color">Product Color</label>
                    <input type="text" name="product_color" class="form-control" id="product_color" placeholder="Enter Product Color" value="{{old('product_color')}}">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" step="any" min="0" name="product_price" class="form-control" id="product_price" placeholder="Enter Product Price" value="{{old('product_price')}}">
                </div>
                <div class="form-group">
                    <label for="product_discount">Product Discount(%)</label>
                    <input type="number" min="0" name="product_discount" class="form-control" id="product_discount" placeholder="Enter Product Discount" value="{{old('product_discount')}}">
                </div>
              </div>  
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="product_weight" class="form-control" id="product_weight" placeholder="Enter Product Weight" value="{{old('product_weight')}}">
                </div>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <textarea name="wash_care" id="wash_care" class="form-control" rows="3" placeholder="Enter ...">{{old('wash_care')}}</textarea>
                </div>
              </div>  
