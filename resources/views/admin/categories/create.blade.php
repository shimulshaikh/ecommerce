            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="category_discount" class="form-control" id="category_discount" placeholder="Enter Category Name">
                </div>
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="url" class="form-control" id="url" placeholder="Enter Category Name">
                </div>
